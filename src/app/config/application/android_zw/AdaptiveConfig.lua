...
config.Login = {
	rewardFontSize = 22,
	upgradeBtnFontSize = 28,
}

config.Help = {
	TabarFontSize = 26,
	SubviewTabarFontSize = 24,
	SubViewFontSize = 24,
	SubViewFontSize2 = 20,
	LevelSystemFontSize = 20,
}
...
config.RoomChat = {
	EditBoxPlaceholderFontSize = 24,
	QuickChatFontSize = 30;
}

config.SNGLobby = {
	RankGapWithPreviousFontSize = 20,
	MonthMatchIncomeFontSize = 24,
	TitleFontName = 'creator/common/fonts/default_bd.ttf',
}

config.PrivateRoom = {
    MotifyPwdPlaceholderFontSize = 20
}

config.SuperLotto = {
	TextClickFontSize = 24,
	RewardPokerPosX = 50,
}
