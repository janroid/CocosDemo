--[[--ldoc desc
@module MTTDetailRewardCell
@author RyanXu

Date   2018-12-24
]]
-- local ViewScene = import("framework.scenes").ViewScene;
local MTTDetailRewardCell = class("MTTDetailRewardCell",cc.TableViewCell)

-- 配置事件监听函数
MTTDetailRewardCell.s_eventFuncMap = {
}

function MTTDetailRewardCell:ctor()
	self:init()
end


function MTTDetailRewardCell:init()
...
function MTTDetailRewardCell:updateCell(data)
