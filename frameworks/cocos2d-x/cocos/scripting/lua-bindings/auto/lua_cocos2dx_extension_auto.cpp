...
int lua_cocos2dx_extension_TableView_setHeaderView(lua_State* tolua_S)
{
	int argc = 0;
	cocos2d::extension::TableView* cobj = nullptr;
	bool ok = true;
	...
	if (!cobj)
	{
		tolua_error(tolua_S, "invalid 'cobj' in function 'lua_cocos2dx_extension_TableView_setHeaderView'", nullptr);
		return 0;
	}
#endif
	...
	if (argc == 1)
	{
		...
		ok &= luaval_to_object<cocos2d::Node>(tolua_S, 2, "cc.Node", &arg0, "cc.TableView:setHeaderView");
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'lua_cocos2dx_extension_TableView_setHeaderView'", nullptr);
			return 0;
		}
		cobj->setHeaderView(arg0);
		lua_settop(tolua_S, 1);
		return 1;
	}
	luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.TableView:setHeaderView", argc, 1);
	return 0;

#if COCOS2D_DEBUG >= 1
	tolua_lerror:
				tolua_error(tolua_S, "#ferror in function 'lua_cocos2dx_extension_TableView_setHeaderView'.", &tolua_err);
#endif

				return 0;
}
int lua_cocos2dx_extension_TableView_setBottomView(lua_State* tolua_S)
{
	int argc = 0;
	cocos2d::extension::TableView* cobj = nullptr;
	bool ok = true;
	...
	if (!cobj)
	{
		tolua_error(tolua_S, "invalid 'cobj' in function 'lua_cocos2dx_extension_TableView_setBottomView'", nullptr);
		return 0;
	}
#endif
	...
	if (argc == 1)
	{
		...
		ok &= luaval_to_object<cocos2d::Node>(tolua_S, 2, "cc.Node", &arg0, "cc.TableView:setBottomView");
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'lua_cocos2dx_extension_TableView_setBottomView'", nullptr);
			return 0;
		}
		cobj->setBottomView(arg0);
		lua_settop(tolua_S, 1);
		return 1;
	}
	luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.TableView:setBottomView", argc, 1);
	return 0;

#if COCOS2D_DEBUG >= 1
	tolua_lerror:
				tolua_error(tolua_S, "#ferror in function 'lua_cocos2dx_extension_TableView_setBottomView'.", &tolua_err);
#endif
...
int lua_register_cocos2dx_extension_TableView(lua_State* tolua_S)
{
	...
	tolua_function(tolua_S, "setHeaderView", lua_cocos2dx_extension_TableView_setHeaderView);
	tolua_function(tolua_S, "setBottomView", lua_cocos2dx_extension_TableView_setBottomView);
