...
public:
	...
	VxMsgNetSendStream* createStream(int nMsgType, int nMsgSize, const char* pMsgData);
	void send(int nMsgType, int nMsgSize, const char* pMsgData);
private:
