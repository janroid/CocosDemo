...
//import com.boyaa.entity.common.utils.CallLuaUtil;
...
//                CallLuaUtil.call(HandMachine.kPlayStoreInit, HandMachine.kCallFailed, new String[]{"flag"}, new Object[]{"google play is not support"});
            }
		} catch (Exception e) {
    ...
    public void launchPurchaseFlow(Activity act, String sku, String itemType, int requestCode,
        ...
        {
        	IabResult r = new IabResult(IABHELPER_UNKNOWN_ERROR, "service or context is null");
            flagEndAsync();
            if (listener != null) listener.onIabPurchaseFinished(r, null);
        	return;
        }
